				...
				<div class="row">
					<div class="navbar-header">
						<div class="navbar-brand">
				      		<a class="main-logo" href="<?php bloginfo('url'); ?>" title="<?php bloginfo('name'); ?>"><h1 class="none"><?php bloginfo('name'); ?></h1><img class="logo" src="<?php bloginfo('template_url'); ?>/img/index/logo-header.png" /></a>
				      	</div>
