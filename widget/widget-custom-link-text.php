...
class Custom_Link extends WP_Widget {
	...
	<div class="widget-custom-link <?php echo $custom_class ? $custom_class : ''; ?>">
		<?php echo $url ? '<a href="'.$url.'">':''; ?>
			...
			<?php if (!is_home()) : ?>
				<?php if($info): ?>
					<div class="widget-custom-link-info">
						<p><?php echo $info; ?></p>
	...
	function form( $instance ) {
		...
		<div class="customLink">
			...
			<!-- Your Info: Text Input -->
			<p>
				<label for="?php echo $this->get_field_id( 'info' ); ?>"><?php _e('Info:', 'CustomLink'); ?></label>
				<textarea id="<?php echo $this->get_field_id( 'info' ); ?>" name="<?php echo $this->get_field_name( 'info' ); ?>" style="width:100%;" ><?php echo $instance['info']; ?></textarea>
			<!-- Your URL: Text Input -->
			<p>
