...
function nw_register_sidebars() {
	...
	register_sidebar(array(
		'id' => 'somos', // Change the id
		'name' => 'Somos', // Change the name
	...
	register_sidebar(array(
		'id' => 'servicios', // Change the id
		'name' => 'Servicios', // Change the name
	...
	register_sidebar(array(
		'id' => 'about-us', // Change the id
		'name' => 'The Knowledge Applied', // Change the name
		'description' => 'The first (primary) sidebar.', // Better change description too!
		'before_widget' => '<div id="%1$s" class="widget %2$s">',
		'after_widget' => '</div>',
		'before_title' => '<h4 class="widgettitle">',
	...
	register_sidebar(array(
		'id' => 'cta', // Change the id
		'name' => 'Solicita una Asesoría', // Change the name
		'description' => 'The first (primary) sidebar.', // Better change description too!
		'before_widget' => '<div id="%1$s" class="widget %2$s">',
		'after_widget' => '</div>',
		'before_title' => '<h4 class="widgettitle">',
	...
	register_sidebar(array(
		'id' => 'negocios', // Change the id
		'name' => 'Áreas de Negocio', // Change the name
		'description' => 'The first (primary) sidebar.', // Better change description too!
		'before_widget' => '<div id="%1$s" class="widget %2$s">',
		'after_widget' => '</div>',
		'before_title' => '<h4 class="widgettitle">',
	...
	register_sidebar(array(
		'id' => 'legales', // Change the id
		'name' => 'Legales', // Change the name
		'description' => 'The first (primary) sidebar.', // Better change description too!
		'before_widget' => '<div id="%1$s" class="widget %2$s">',
		'after_widget' => '</div>',
		'before_title' => '<h4 class="widgettitle">',
...
require_once( 'widget/widget-custom-link-text.php' ); // Agrega un custom url, icon o imagen.
